...
WINDOW_PATTERN = "L"    # simpler full attention works better on smaller GPUs
USE_MODEL_COMPILE = False # disable full-model compile on smaller GPUs to save memory

# Optimization
TOTAL_BATCH_SIZE = 2**17 # smaller total batch for a 32GB single-GPU regime
